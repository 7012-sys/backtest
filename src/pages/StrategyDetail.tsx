        ...
        <>
          ...
          <Tabs defaultValue="overview" className="space-y-4">
            <TabsList className="w-full sm:w-auto">
              <TabsTrigger value="overview" className="gap-1.5 flex-1 sm:flex-none"><Layers className="h-3.5 w-3.5" /> Overview</TabsTrigger>
              <TabsTrigger value="backtests" className="gap-1.5 flex-1 sm:flex-none"><BarChart3 className="h-3.5 w-3.5" /> Backtests</TabsTrigger>
            </TabsList>

            <TabsContent value="overview">
              <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                <Card>
                  <CardHeader className="pb-3"><CardTitle className="text-sm text-success">Entry Rules (Buy)</CardTitle></CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-3"><CardTitle className="text-sm text-destructive">Exit Rules (Sell)</CardTitle></CardHeader>
                  <CardContent>
                    {(rules?.exit ?? []).length === 0 ? (
